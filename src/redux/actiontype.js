...
export const LOAD_PROOFILE = 'LOAD_PROOFILE'
...
export const HOME_VIDEOS_SECCESS = 'HOME_VIDEOS_SECCESS';
...
export const GET_SUBSCTIPTION_STATUS = 'GET_SUBSCTIPTION_STATUS';
export const SET_SUBSCTIPTION_STATUS = 'SET_SUBSCTIPTION_STATUS';

export const COMMENT_LIST_REQUEST = 'COMMENT_LIST_REQUEST';
export const COMMENT_LIST_SECCESS = 'COMMENT_LIST_SECCESS';
